...
/// <summary>
/// Top-level GEDCOM records GT4 has no model for — submitter, submission, source, repository, multimedia — are
...
internal static class GedcomMetadata
{
  ...
  private static readonly HashSet<string> PassthroughTags =
    [GedcomTags.Submitter, GedcomTags.Submission, GedcomTags.Source, GedcomTags.Repository, GedcomTags.Object];
