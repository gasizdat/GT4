...
public class GT4Services
{
  public static void Add(IServiceCollection serviceCollection)
  {
    ...
    serviceCollection
      ...
      .AddKeyedSingleton<IDataConverter>(DataCategory.PersonAttachment, (_, _) => new AttachmentDataConverter(DataCategory.PersonAttachment))
      .AddKeyedSingleton<IDataConverter>(DataCategory.FamilyAttachment, (_, _) => new AttachmentDataConverter(DataCategory.FamilyAttachment))
