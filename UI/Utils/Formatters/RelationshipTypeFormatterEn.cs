...
internal class RelationshipTypeFormatterEn : RelationshipTypeFormatterBase
{
  ...
  protected string D0_C1()
  {
    var table = new Table
    {
      ...
      // English (and German, Spanish, French, which reuse this table) doesn't distinguish "my
      // spouse's sibling" from "my sibling's spouse": both are just brother-/sister-in-law.
      [RelationshipType.HusbandSibling] = new(F: S.RelBrothersWife, M: S.RelSistersHusband, U: S.RelSiblingSpouse),
      [RelationshipType.WifeSibling] = new(F: S.RelBrothersWife, M: S.RelSistersHusband, U: S.RelSiblingSpouse),
      [RelationshipType.SpouseSibling] = new(F: S.RelBrothersWife, M: S.RelSistersHusband, U: S.RelSiblingSpouse),
      [RelationshipType.AdoptiveSibling] = new(F: S.RelAdoptiveFemale_1, M: S.RelAdoptiveMale_1, U: S.RelAdoptiveInvariant_1, RelationshipType.Sibling),
      [RelationshipType.SiblingByFather] = new(F: S.RelParental_1, M: S.RelParental_1, U: S.RelParental_1, RelationshipType.Sibling),
      [RelationshipType.SiblingByMother] = new(F: S.RelMaternal_1, M: S.RelMaternal_1, U: S.RelMaternal_1, RelationshipType.Sibling),
      [RelationshipType.StepSibling] = new(F: S.RelStepFemale_1, M: S.RelStepMale_1, U: S.RelStepInvariant_1, RelationshipType.Sibling),
